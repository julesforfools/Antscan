...
def set_voxel_spacing(image_path, image):
    ...
    '''Not implemented yet due to general disagreement between TIFF and Segmentation softwares '''
...
def mask2crop2(image, mask, dil_it=10):
    ...
    !!! Due to high number of small errors, masking is not successfully implemented yet !!!
    '''
...
for specimen in specimens:
    ...
    results = deep_learning(main_image, predict=True, img_header=img_header,
        path_to_model=sys.argv[4], img_extension=img_ext, batch_size = 24)
